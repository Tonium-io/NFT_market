...
./tonos-cli --url $NETWORK deploy $DEBOT_NAME.tvc "{\"name\":\"5423\",\"symbol\":\"5423\",\"decimals\":0,\"root_public_key\":\"0xf66a20b278b2064684b56c99baa5e2703ff7724617148a7a380fbd2133d866a4\",\"wallet_code\":\"$CODE\"}" --sign $DEBOT_NAME.keys.json --abi $DEBOT_NAME.abi.json
